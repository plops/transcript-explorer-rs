...
- [ ] 1. Create message types and channel infrastructure
...
- [ ] 2. Create UpdateOverlayState and state management
  - [ ] 2.1 Define UpdateOverlayState struct and UpdateState enum
  ...
  - [ ] 2.2 Implement UpdateOverlayState::new() and process_message()
  ...
  - [ ] 2.6 Implement UpdateOverlayState::handle_key()
...
- [ ] 3. Implement TuiModeHandler for update module
  - [ ] 3.1 Create TuiModeHandler struct
  ...
  - [ ] 3.2 Implement ModeHandler trait for TuiModeHandler
...
- [ ] 4. Add TUI mode support to UpdateManager
  - [ ] 4.1 Add new_with_tui_mode() constructor
...
- [ ] 5. Checkpoint - Ensure update module tests pass
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 6. Implement update overlay rendering
  - [ ] 6.1 Create rendering helper functions
    - Implement `centered_rect()` helper function
    - Implement `format_bytes()` helper function
    - Add imports for ratatui widgets and layout
    - _Requirements: 2.2_

  - [ ] 6.2 Implement state-specific rendering functions
  ...
  - [ ] 6.3 Implement main render() function
...
- [ ] 7. Create PasswordInputOverlay component
  - [ ] 7.1 Define PasswordInputOverlay struct and methods
  ...
  - [ ] 7.2 Implement password input key handling
  ...
  - [ ] 7.6 Implement password overlay rendering
...
- [ ] 8. Integrate update overlay into App
  - [ ] 8.1 Add update overlay fields to App struct
  ...
  - [ ] 8.2 Add channel setup and message polling methods
...
- [ ] 9. Update main UI rendering to include overlay
...
- [ ] 10. Integrate update channels into main event loop
  - [ ] 10.1 Create and split update channels in run_app()
  ...
  - [ ] 10.2 Spawn update thread with TUI mode
  ...
  - [ ] 10.3 Add update message polling to event loop
  ...
  - [ ] 10.4 Add update overlay key handling to event loop
...
- [ ] 11. Implement password entry for encrypted databases
  - [ ] 11.1 Add password entry before TUI initialization
  ...
  - [ ] 11.2 Handle password submission and decryption
...
- [ ] 13. Clean up console I/O from update module (optional verification)
